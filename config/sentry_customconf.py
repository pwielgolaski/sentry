...
GENERIC_AUTHORIZE_URL = 'http://oauth:8080/oauth/authorize'
GENERIC_ACCESS_TOKEN_URL = 'http://oauth:8080/oauth/token'
GENERIC_USER_DETAILS_ENDPOINT = 'http://oauth:8080/me'
GENERIC_CLIENT_ID = 'myclient'
GENERIC_CLIENT_SECRET = 'mysecret'
GENERIC_CLIENT_SCOPE = 'access'
